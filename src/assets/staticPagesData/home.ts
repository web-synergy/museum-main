...
export const homeData = {
  ...
  about_history: {
    text: {
      ...
      `,
      text2: `Музей розташований на Андріївському узвозі, в будинку, де Іван Петрович Кавалерідзе, відомий український скульптор і кінорежисер, працював над пам'ятником княгині Ользі.`,
    },
